...
int main() {
    LSH lsh(2, 4, 3);
    std::vector<double> a = {-0.00301999, 0.0510758, 0.09474665, -0.02492699, -0.09574845, 0.00486881,
                             -0.09962147,  0.12455593,  0.05827475,  0.03300984,  0.02116934, 0.10401986, -0.1265259};
    ...
    std::vector<double> d = {-0.01301999, 0.0510758, 0.09474665, -0.02592699, -0.19574845, 0.00486881,
                             -0.09862047,  0.12455593,  0.05827475,  0.03300984,  0.02116934, 0.10401986, -0.1265259};
    std::vector<double> e = {-0.10301999, 0.0510758, 0.09474665, -0.02892699, -0.09574945, 0.00486881,
                             -0.09862047,  0.12455593,  0.05827475,  0.03340984,  0.02116934, 0.10401986, -0.1265259};
    ...
    std::vector<int> answer = lsh.find_k_neighboors(2, 1, a);
